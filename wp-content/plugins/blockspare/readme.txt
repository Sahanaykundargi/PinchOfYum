=== Blockspare - A stunning set of Gutenberg blocks to get you started with the new WordPress editor ===
...
You may design complicated layouts for your website in just a few minutes with our adaptable and inventive blocks. We design an elegant series of WordPress blocks to help you create the website you always wanted with ease. Let’s Start Designing Your Dream Site in Minutes with Blockspare!
...
* Load More Pagination Options for Posts Blocks 
...
* [Latest Posts Block Lite](https://wordpress.org/plugins/blockspare-posts-block-lite/)
...
== Changelog ==
= 2.1.0 =
* Update: Compatibility check with latest WP 6.1.1

= 2.1.0 =
* New: Loadmore paginatios for Post Grid Block
* New: Loadmore paginatios for Express Post Grid Block
* New: Loadmore paginatios for Post List Block
