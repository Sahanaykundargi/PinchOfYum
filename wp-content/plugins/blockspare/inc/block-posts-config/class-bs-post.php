...
function blockspare_query_loop_and_wrapper($attributes,$blockclass ='',$design='',$blockName=''){
   ...
   $grid_query = blockspare_post_query($attributes);
    if ($grid_query->have_posts()) {
        ...
        $class = "wp-block-blockspare-posts-block-blockspare-posts-block-latest-posts blockspare-posts-block-post-wrap align".$alignclass." ".$attributes['blockHoverEffect'] ;
        ...
        <section class="<?php echo esc_attr($class);?>">
            ...
            <?php 
             if($attributes['enablePagination']=='true' && $grid_query->max_num_pages >1){ ?>
                <div class="bs_blockspare_loadmore blockspare-readmore-wrapper" block-name="tile" data-page='2' blockspare-att=<?php echo "'" .  wp_kses_post(wp_json_encode($attributes))."'";?> max-paged="<?php echo $grid_query->max_num_pages;?>">
