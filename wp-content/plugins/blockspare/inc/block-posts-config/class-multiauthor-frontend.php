            ...
            if(isset($awpa_post_authors) && !empty($awpa_post_authors) && $multiauthor_settings == true){
                foreach ($awpa_post_authors as $key=>$author_id) {
                    ...
                    if (strpos($author_id, $needle) !== false) {
                     ...
                     $this->blockspare_front_author_list($post_id,$author_id,$author_type,$authorIcon,$key,$awpa_post_authors);
...
function blockspare_front_author_list($post_id='',$author_id='',$author_type='',$authorIcon,$key,$awpa_post_authors){
