<?php 
    ...
    function blockspare_banner_two_render_block($attributes){
        ...
        ?>
        <div class='<?php  echo esc_attr($blockuniqueclass);?>  <?php echo esc_attr( $animation_class ) ?> blockspare-banner-1-main-wrapper <?php echo esc_attr($attributes['bannerTwoLayout']) ?> align<?php echo esc_attr($alignclass) ?>' blockspare-animation=<?php echo esc_attr( $attributes['animation'] )?>>
    ...
    function blockspare_banner_two_register_block()
    {
        ...
        ob_start();
         include BLOCKSPARE_PLUGIN_DIR . 'inc/block-banner/block.json';
