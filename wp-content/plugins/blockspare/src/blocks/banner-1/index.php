<?php 
    ...
    function blockspare_banner_one_render_block($attributes){
        ...
        ?>
        <div class='<?php  echo esc_attr($blockuniqueclass);?> blockspare-banner-1-main-wrapper <?php echo esc_attr($attributes['bannerOneLayout']) ?> align<?php echo esc_attr($alignclass) ?>'>
