<?php
    ...
    function blockspare_slider_render_block_core_latest_posts_list($attributes)
    {
        ...
        if ($grid_query->have_posts()) {
            ...
            $grid_class = $blockuniqueclass . '  blockspare-posts-block-latest-post-carousel-wrap '.' '  . $listgridClass . ' ' . $list_layout_class. ' has-gutter-space-'.$attributes['gutterSpace'];
    ...
    <div class="<?php echo esc_attr($grid_class);?>">
        <div class="latest-post-carousel" data-slick="<?php echo esc_attr($carousel_args_encoded); ?>"
            ...
            <?php while ($grid_query->have_posts()) {
                        ...
                        $post_classes = 'blockspare-posts-block-post-single '.$contentOrderClass." ".$attributes['contentOrder'];
            ...
            <div id="<?php echo esc_attr($post_id);?>"
                ...
                <div
                    class="blockspare-posts-block-post-content <?php echo esc_attr($attributes['contentOrder']); ?> <?php echo esc_attr($attributes['titleOnHover'])?>">
...
<?php wp_reset_postdata();
    ...
    function blockspare_slider_register_block_core_latest_posts_list()
    {
        ...
        ob_start();
       include BLOCKSPARE_PLUGIN_DIR . 'src/blocks/latest-posts-slider/block.json';
